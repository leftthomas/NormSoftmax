...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_base', default='car_uncropped_fixed_random_resnet18_48_12_data_base.pth', type=str,
    ...
    query_label = data_base['test_labels'][query_index]
    query_feature = data_base['test_features'][query_index]

    gallery_images = data_base['gallery_images']
    gallery_labels = data_base['gallery_labels']
    gallery_features = data_base['gallery_features']
